const FAQ = () => {
    return (
      <div className="mt-10 p-6 rounded-lg shadow-md bg-white">
        ...
        {[
          { question: "Are there any additional charges when booking a lab test through TestSahulat?", answer: "No, there are no hidden charges." },
          { question: "Can I see my lab test results online in Pakistan?", answer: "Yes, most labs provide online reports." },
          { question: "How to check online lab reports in Pakistan?", answer: "You can check online lab reports through TestSahulat's dashboard." },
          { question: "How long does lab testing take for COVID?", answer: "It typically takes 24-48 hours, depending on the lab." },
          { question: "Where to find the best lab in Pakistan?", answer: "TestSahulat provides a list of top-rated labs across Pakistan." },
